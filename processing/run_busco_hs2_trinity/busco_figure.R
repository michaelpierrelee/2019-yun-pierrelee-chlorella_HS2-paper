...
# Output
my_output <- paste("run_busco_hs2_trinity/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('busco_hs2_trinity', 'busco_hs2_trinity', 'busco_hs2_trinity', 'busco_hs2_trinity')
...
my_percentage <- c(20.0, 69.4, 6.3, 4.3)
my_values <- c(433, 1505, 136, 94)
