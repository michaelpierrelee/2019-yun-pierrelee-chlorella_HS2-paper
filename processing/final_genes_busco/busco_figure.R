...
# Output
my_output <- paste("final_genes_busco/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('final_genes_busco', 'final_genes_busco', 'final_genes_busco', 'final_genes_busco')
...
my_percentage <- c(9.7, 29.1, 3.6, 57.6)
my_values <- c(210, 630, 79, 1249)
